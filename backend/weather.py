...
WX_SYMBOL = {
    ...
    "lightrainandthunder":          ("⛈️", "Rain + thunder"),
    "rainandthunder":               ("⛈️", "Rain + thunder"),
    "heavyrainandthunder":          ("⛈️", "Heavy rain + thunder"),
    "lightrainshowersandthunder":   ("⛈️", "Showers + thunder"),
    "rainshowersandthunder":        ("⛈️", "Showers + thunder"),
    "heavyrainshowersandthunder":   ("⛈️", "Heavy showers + thunder"),
    ...
    "lightsleetandthunder":         ("⛈️", "Sleet + thunder"),
    "sleetandthunder":              ("⛈️", "Sleet + thunder"),
    "heavysleetandthunder":         ("⛈️", "Heavy sleet + thunder"),
    "lightsleetshowersandthunder":  ("⛈️", "Sleet + thunder"),
    "sleetshowersandthunder":       ("⛈️", "Sleet + thunder"),
    "heavysleetshowersandthunder":  ("⛈️", "Heavy sleet + thunder"),
    ...
    "lightsnowandthunder":          ("⛈️", "Snow + thunder"),
    "snowandthunder":               ("⛈️", "Snow + thunder"),
    "heavysnowandthunder":          ("⛈️", "Heavy snow + thunder"),
    "lightsnowshowersandthunder":   ("⛈️", "Snow + thunder"),
    "snowshowersandthunder":        ("⛈️", "Snow + thunder"),
    "heavysnowshowersandthunder":   ("⛈️", "Heavy snow + thunder"),
}
