...
h+='<div class="sc">Integrations</div><div class="c"><span style="font-size:20px">🔵</span><div class="bd"><div class="tt">Trello Sync</div><div style="font-size:12px;color:var(--ht)">Board: Работа ('+['Монтаж видео','Сайты','Бренд','Видеосъемка'].join(', ')+')</div></div><button class="btn btn-s" id="trello-btn" onclick="syncTrello()" style="font-size:13px;flex-shrink:0">Sync Now</button></div>';
