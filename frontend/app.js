...
h+='<div class="sc">Integrations</div><div class="c" style="gap:12px"><span style="font-size:20px;flex-shrink:0">🔵</span><div class="bd" style="min-width:0"><div class="tt">Trello Sync</div><div style="font-size:12px;color:var(--ht);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">Board: Работа</div></div><button class="btn btn-s" id="trello-btn" onclick="syncTrello()" style="font-size:13px;flex-shrink:0;white-space:nowrap">Sync Now</button></div>';
