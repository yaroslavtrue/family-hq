...
return h}
function rEvtAddBtn(){return '<button class="btn btn-s" style="margin:14px 0 16px" onclick="oMoEvt()">+ Add Event</button>'}
...
h+='<div style="margin-top:8px;text-align:center;font-size:11px;color:var(--ht)">Family HQ v8.12.2</div>';return h}
