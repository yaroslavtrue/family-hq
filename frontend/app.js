...
// ─── State ──────────────────────────────────────────────────
let tab="home",filt=null,fS=null,ex={},dbgOn=false,dbgLog=[];
// ─── i18n (v8.34.0) ─────────────────────────────────────────────────
...
h+='<div style="margin-top:18px;text-align:center;font-size:11px;color:var(--ht);letter-spacing:.3px">Family HQ v8.36.0</div>';return h}
