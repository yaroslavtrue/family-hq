...
// moneyTab moved to /static/money.js in v8.43.0 as `var moneyTab` (window-scope).
let taskTab="active",calTab="events",shopFold=null,searchQ="",searchOpen=false,menuOpen=false;
