...
window.LANG = {
  en: {
    ...
    life_hint_personal: "Tap an area to grow it · hold to rename",
    life_hint_family: "Your connection — tap an area to nurture it",
    life_hint_area: "Tap a habit · tap + to plant a new one",
    life_hint_area_empty: "Tap + to plant your first habit here",
  ...
  ru: {
    ...
    life_hint_personal: "Тапни область, чтобы растить · удержи, чтобы переименовать",
    life_hint_family: "Ваша связь — тапни область, чтобы её питать",
    life_hint_area: "Тапни привычку · «+» чтобы посадить новую",
    life_hint_area_empty: "Тапни «+», чтобы посадить первую привычку",
