...
window.LANG = {
  en: {
    ...
    // Event tracker (v8.62.0)
    life_new_event: "Log an event", life_event: "Event", life_edit_event: "Edit event",
    life_event_name: "What happened", life_event_ph: "e.g. Met friends",
    life_count_lbl: "this month", life_past_ro: "Past month — view only",
    life_pin: "Pin", life_pinned: "Pinned", life_pin_hint: "Pinned events carry over to next month",
    life_hint_events: "Tap an event to relive it · hold empty space to add",
    life_hint_events_empty: "Hold empty space to log your first event",
    life_ch_name: "Name",
    ...
    life_j_activity: "Activity · this month", life_j_events: "Events", life_j_total: "Total",
    life_j_this_week: "Last 7 days", life_j_top: "Top event",
    life_j_empty: "Log a few events to see your month grow",
    ...
    set_delete_q: "Delete your account permanently? This cannot be undone.",
    set_delete_member: "Your account and personal data will be deleted. Shared family data stays with the other members. Continue?",
    set_delete_last: "You are the last member: the whole family and ALL its data will be deleted. Continue?",
    set_delete_fail: "Could not delete the account. Try again later.",
    ...
    set_weather: "Weather",
    set_weather_city: "Weather city",
    set_weather_city_cur: "Current city",
    set_weather_city_ph: "Search a city…",
    loc_title: "Local weather",
    loc_body: "Allow location and Moya will show the weather for your city. You can change it anytime in Settings.",
    loc_allow: "Allow location",
    loc_later: "Not now",
    loc_detect: "Detect automatically",
    loc_done: "Location set",
    loc_failed: "Couldn't get your location",
    loc_unavailable: "Location isn't available in this build",
    // Push notifications (FCM, native app)
    set_notifs_push: "Push notifications",
    set_notifs_push_sub: "Reminders for tasks, events and birthdays",
    push_title: "Stay in the loop",
    push_body: "Turn on push notifications and Moya will remind you about tasks, events and birthdays — even when the app is closed.",
    push_allow: "Turn on notifications",
    push_later: "Not now",
    push_on: "On",
    push_off: "Off",
    push_denied: "Notifications are blocked. You can enable them in system settings.",
    push_unavailable: "Notifications aren't available in this build",
    // Cooking (v8.48.0)
  ...
  ru: {
    ...
    // Трекер событий (v8.62.0)
    life_new_event: "Добавить событие", life_event: "Событие", life_edit_event: "Изменить событие",
    life_event_name: "Что произошло", life_event_ph: "напр. Встретился с друзьями",
    life_count_lbl: "в этом месяце", life_past_ro: "Прошлый месяц — только просмотр",
    life_pin: "Закрепить", life_pinned: "Закреплено", life_pin_hint: "Закреплённые события переходят на следующий месяц",
    life_hint_events: "Тапни событие чтобы повторить · удержи фон чтобы добавить",
    life_hint_events_empty: "Удержи пустое место чтобы добавить первое событие",
    life_ch_name: "Название",
    ...
    life_j_activity: "Активность · этот месяц", life_j_events: "Событий", life_j_total: "Всего",
    life_j_this_week: "За 7 дней", life_j_top: "Топ событие",
    life_j_empty: "Добавь пару событий, чтобы увидеть месяц",
    ...
    set_delete_q: "Удалить аккаунт навсегда? Отменить это нельзя.",
    set_delete_member: "Аккаунт и личные данные будут удалены. Общие данные семьи останутся у остальных участников. Продолжить?",
    set_delete_last: "Ты последний участник: семья и ВСЕ её данные будут удалены. Продолжить?",
    set_delete_fail: "Не удалось удалить аккаунт. Попробуй позже.",
    ...
    news_next: "Далее", news_back: "Назад",
    ...
    set_weather: "Погода",
    set_weather_city: "Город погоды",
    set_weather_city_cur: "Текущий город",
    set_weather_city_ph: "Найти город…",
    loc_title: "Погода твоего города",
    loc_body: "Разреши доступ к геолокации — Moya покажет погоду твоего города. Город можно изменить в настройках в любой момент.",
    loc_allow: "Разрешить геолокацию",
    loc_later: "Не сейчас",
    loc_detect: "Определить автоматически",
    loc_done: "Город определён",
    loc_failed: "Не удалось определить местоположение",
    loc_unavailable: "Геолокация недоступна в этой сборке",
    // Push notifications (FCM, native app)
    set_notifs_push: "Push-уведомления",
    set_notifs_push_sub: "Напоминания о задачах, событиях и днях рождения",
    push_title: "Будь в курсе",
    push_body: "Включи push-уведомления — и Moya напомнит о задачах, событиях и днях рождения, даже когда приложение закрыто.",
    push_allow: "Включить уведомления",
    push_later: "Не сейчас",
    push_on: "Вкл",
    push_off: "Выкл",
    push_denied: "Уведомления заблокированы. Включи их в системных настройках.",
    push_unavailable: "Уведомления недоступны в этой сборке",
    // Cooking (v8.48.0)
